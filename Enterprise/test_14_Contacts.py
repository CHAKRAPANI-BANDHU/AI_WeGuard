...
# def test_tc_14000_Create_Contacts_Account_Level_POST(url):
#     now1 = datetime.now()
...
# @pytest.mark.parametrize('url', [""])
# @pytest.mark.skipif(Execute.test_tc_14001_Contacts_Account_Level_FCM_UPDATE_After_CreatingAdding_Contacts_POST == 0,
#                     reason="skip test")
# @pytest.mark.poitivetest
# @pytest.mark.contacts
# @pytest.mark.regressiontest
# @pytest.mark.run(order=14001)
# def test_tc_14001_Contacts_Account_Level_FCM_UPDATE_After_CreatingORAdding_Contacts_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14002_Account_Level_Contacts_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14003_Contacts_Account_Level_DELETE(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14004_Contacts_Account_Level_FCM_UPDATE_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14005_Create_Contacts_Policy_Level_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# # Policy Level: POST method to sync contacts on the devices through FCM Update after creating/adding accounts
# @pytest.mark.parametrize('url', [""])
# @pytest.mark.skipif(Execute.test_tc_14006_Contacts_Policy_Level_FCM_UPDATE_After_CreatingAdding_Contacts_POST == 0,
#                     reason="skip test")
# @pytest.mark.poitivetest
# @pytest.mark.contacts
# @pytest.mark.regressiontest
# @pytest.mark.run(order=14006)
# def test_tc_14006_Contacts_Policy_Level_FCM_UPDATE_After_CreatingORAdding_Contacts_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14007_Policy_Level_Contacts_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14008_Contacts_Policy_Level_DELETE(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
# def test_tc_14009_Contacts_Policy_Level_FCM_UPDATE_POST(url):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
