...
#             "message": "{\"textColor\":\"#ffffff\",\"bgColor\":\"#000000\",\"textType\":\"normal\",\"title\":\"Alert! - Plain Text --> All Level\",\"iconUrl\":\"https://stage-cache.weguard.ai/qa-cache-weguard-io/64cb86dd80f4b80b1dc65e73/238ed64b982bc5d4274d812d1b354157/5.1.15ITVIRTUsers.png\",\"body\":\"Today's weather: sunny with a chance of rain.\"}",
...
#         Headers = {'Authorization': 'Bearer {}'.format(globalvar.bearerToken)}
#         Payload = {
#             "message": "{\"textColor\":\"#ffffff\",\"bgColor\":\"#000\",\"textType\":\"normal\",\"title\": \"Alert! - Plain Text --> Group Level\",\"body\":\"Today's weather: sunny with a chance of rain.\"}",
...
#             "message": "{\"textColor\":\"#ffffff\",\"bgColor\":\"#000000\",\"textType\":\"normal\",\"body\":\"Today's weather: sunny with a chance of rain.\",\"title\":\"Alert! - Plain Text --> Device Level\"}",
...
#         Headers = {'Authorization': 'Bearer {}'.format(globalvar.bearerToken)}
#         Payload = {"textColor": "#ffffff", "bgColor": "#000", "textType": "rich", "title": "Alert! - Rich Text --> All Level",
#                    "body": "QA href=\"https://qa-cloud.weguard.ai/#/login\" target=\"_blank\">https://qa-cloud.weguard.ai/#/login</a>"}
#         res = requests.post(url=apiUrl, headers=Headers, json=Payload, timeout=globalvar.timeout)
#         if res.status_code == 200:
#             print("\n" + "200 The request was a success!")
#             curl_str1 = Utils.getCurlEquivalent(res)
...
#             "type": "FCM_MESSAGE", "isLicenseLevel": True, "actCode": globalvar.activationCode,
#             "pActCode": globalvar.productActivationCode,
#             "message": "{\"textColor\":\"#ffffff\",\"bgColor\":\"#000000\",\"textType\":\"rich\",\"title\":\"Alert! - Rich Text --> All Level\",\"iconUrl\":\"https://stage-cache.weguard.ai/qa-cache-weguard-io/64cb86dd80f4b80b1dc65e73/238ed64b982bc5d4274d812d1b354157/5.1.15ITVIRTUsers.png\",\"body\":\"Today's weather: sunny with a chance of rain.\", \"bMsgBodyRef\":\"" + globalvar.LicensesBroadcastReqID[0] + "\"}",
#             "pId": None, "priority": "high", "id": str(Request.RandomID), "reqId": str(Request.UUID)}
#         res = requests.post(url=apiUrl, headers=Headers, json=Payload, timeout=globalvar.timeout)
#         if res.status_code == 200:
#             print("\n" + "200 The request was a success!")
...
#         apiUrl = globalvar.BaseURL + BroadcastMessageRichText
#         Headers = {'Authorization': 'Bearer {}'.format(globalvar.bearerToken)}
#         Payload = {"textColor": "#ffffff", "bgColor": "#000", "textType": "rich", "body": "qa", "title": "Alert! - Rich Text --> Group Level"}
#         res = requests.post(url=apiUrl, headers=Headers, json=Payload, timeout=globalvar.timeout)
#         if res.status_code == 200:
#             print("\n" + "200 The request was a success!")
#             curl_str1 = Utils.getCurlEquivalent(res)
...
#         Headers = {'Authorization': 'Bearer {}'.format(globalvar.bearerToken)}
#         Payload = {
#             "message": "{\"textColor\":\"#ffffff\",\"bgColor\":\"#000\",\"textType\":\"normal\",\"title\": \"Alert! - Rich Text --> Group Level\",\"body\":\"Today's weather: sunny with a chance of rain.\"}",
#             "policies": [{"WCM": False, "policyName": globalvar.Android_All_Policy_Names[0],
#                           "policyId": globalvar.Android_All_Policy_IDs[0],
#                           "reqId": Request.UUID}], "id": Request.RandomID, "reqId": Request.UUID}
#         res = requests.post(url=apiUrl, headers=Headers, json=Payload, timeout=globalvar.timeout)
...
#             "title": "Alert! - Rich Text --> Device Level"
#         }
#         res = requests.post(url=apiUrl, headers=Headers, json=Payload, timeout=globalvar.timeout)
#         if res.status_code == 200:
#             print("\n" + "200 The request was a success!")
...
#             "type": "FCM_MESSAGE", "isLicenseLevel": False,
#             "actCode": globalvar.activationCode, "pActCode": globalvar.productActivationCode,
#             "message": "{\"textColor\":\"#ffffff\",\"bgColor\":\"#000000\",\"textType\":\"normal\",\"body\":\"Today's weather: sunny with a chance of rain.\",\"title\": \"Alert! - Rich Text --> Device Level\", \"bMsgBodyRef\":\"" + str(
#                 globalvar.LicensesBroadcastReqID) + "\"}",
