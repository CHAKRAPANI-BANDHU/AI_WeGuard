...
#
# # Device Commands (Not added App Install and Uninstall Application, Remove accounts by domain, Clear app data
# Device_Commands = ["RESTART_DEVICE", "POWER_OFF_DEVICE", "LOCK_DEVICE", "UNLOCK_DEVICE", "KIOSK_PASSWORD_RESET_DEVICE",
#                    "FCM_RESTART_DEVICE", "FCM_RESTART_DEVICE", "FORCE_POLICY_REFRESH", "FCM_APK_DU", "READ_DATA_USAGE",
#                    "FCM_LAUNCH_APP", "FCM_DELETE_APK_DIR", "FCM_DELETE_LOG_DIR", "FCM_CLEAR_WALLPAPER_DIR",
#                    "REMOVE_ALL_ACCOUNTS", "FCM_REMOVE_EMM_ACCOUNT", "KILL_APP_BACKGROUND", "FCM_UNINSTALL_APP",
#                    "DELETE_PERSONA_WALLPAPER_DIRECTORY", "DELETE_ADMIN_LOCK_WALLPAPER_DIRECTORY",
#                    "DELETE_BUG_REPORT_DIRECTORY"]
# Admin_Device_Commands = ["ADMIN_LOCK", "ADMIN_UNLOCK"]
# # Define a list of True and False to alternate between test cases Wipe, Uninstall WeGuard
# EraseDevice = [True, False]
#
#
...
# @pytest.mark.devicedetailsview
# @pytest.mark.regressiontest
# def test_tc_5021_Android_Device_Commands(device_command):
#     now1 = datetime.now()
...
#
#
# # Update Device -- Uninstall WeGuard, Wipe Commands
# @pytest.mark.parametrize('url, erase_device', [("url1", erase) for erase in EraseDevice])
# @pytest.mark.skipif(Execute.test_tc_5018_POST_Android_Device_TagsIDs == 0,
#                     reason="Update Device -- Uninstall WeGuard, Wipe Commands is skipped")
# @pytest.mark.positivetest
# @pytest.mark.devicedetailsview
# @pytest.mark.regressiontest
# @pytest.mark.run(order=50018)
# def test_tc_5018_Android_Device_TagsIDs(url, erase_device):
#     now1 = datetime.now()
#     if globalvar.bearerToken == '':
#         pytest.skip("Empty Bearer token Skipping test")
#     try:
...
#                            {"deviceID": AndroidDeviceID, "id1": "QA Team", "id2": "1201" + str(GeneralPayload.RandomID),
#                             "id3": None,
#                             "adminTaggedName": "In-House", "wiped": erase_device, "simLockPin": None,
#                             "resetPassword": None,
#                             "enableWeguardUninstall": not erase_device}]}
#             res = requests.post(url=apiUrl, headers=Headers, json=TagsIDs, timeout=globalvar.timeout)
#             curl_str1 = Utils.getCurlEquivalent(res)
#             print(curl_str1)
#             if res.status_code == 200:
