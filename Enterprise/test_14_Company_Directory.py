...
@pytest.mark.skipif(Execute.test_tc_14000_CompanyDirectory_Account_Level_Create_Contacts_POST == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14000)
def test_tc_14000_CompanyDirectory_Create_Contacts_Account_Level_POST(url):
    now1 = datetime.now()
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14001_CompanyDirectory_Account_Level_FCM_UPDATE_After_CreatingAdding_Contacts_POST == 0,
                    reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14001)
def test_tc_14001_CompanyDirectory_Account_Level_FCM_UPDATE_After_CreatingORAdding_Contacts_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14002_CompanyDirectory_Account_Level_POST == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14002)
def test_tc_14002_CompanyDirectory_Account_Level_Contacts_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14003_CompanyDirectory_Account_Level_DELETE == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14003)
def test_tc_14003_CompanyDirectory_Account_Level_DELETE(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14004_CompanyDirectory_Account_Level_FCM_UPDATE_POST == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14004)
def test_tc_14004_CompanyDirectory_Account_Level_FCM_UPDATE_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14005_CompanyDirectory_Policy_Level_Create_Contacts_POST == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14005)
def test_tc_14005_CompanyDirectory_Policy_Level_Create_Contacts_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
        for policy_id in globalvar.Android_Policy_IDs:
            ...
            res = requests.post(url=apiUrl, headers=headers, json=CreateContactsPolicyLevel, timeout=globalvar.timeout)
            if res.status_code == 200:
                curl_str1 = Utils.getCurlEquivalent(res)
                print(curl_str1)
                print("\n" + "200 The request was a success!")
...
# Policy Level: POST method to sync contacts on the devices through FCM Update after creating/adding accounts
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14006_CompanyDirectory_Policy_Level_FCM_UPDATE_After_CreatingAdding_Contacts_POST == 0,
                    reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14006)
def test_tc_14006_CompanyDirectory_Policy_Level_FCM_UPDATE_After_CreatingORAdding_Contacts_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14007_CompanyDirectory_Policy_Level_POST == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14007)
def test_tc_14007_CompanyDirectory_Policy_Level_Contacts_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14008_CompanyDirectory_Policy_Level_DELETE == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14008)
def test_tc_14008_CompanyDirectory_Policy_Level_DELETE(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
...
@pytest.mark.parametrize('url', [""])
@pytest.mark.skipif(Execute.test_tc_14009_CompanyDirectory_Policy_Level_FCM_UPDATE_POST == 0, reason="skip test")
@pytest.mark.poitivetest
@pytest.mark.contacts
@pytest.mark.regressiontest
@pytest.mark.run(order=14009)
def test_tc_14009_CompanyDirectory_Policy_Level_FCM_UPDATE_POST(url):
    now1 = datetime.now()
    if globalvar.bearerToken == '':
        pytest.skip("Empty Bearer token Skipping test")
    try:
