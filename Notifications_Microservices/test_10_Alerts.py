...
# def test_AlertTypes_and_AlertLevels(url):
#     now1 = datetime.now()
#     try:
...
#         pytest.skip("Empty Bearer token. Skipping test")
#     try:
#         TodaysAlertsTypesLevelAll = AllAlerts(globalvariables.accountId, globalvariables.isostart, globalvariables.isoend, globalvariables.page_1,
...
#         pytest.skip("Empty Bearer token. Skipping test")
#     try:
#         AlertsTypesLevelAllYesterday = AllAlerts(globalvariables.accountId, globalvariables.isocustom, globalvariables.isoyesterday,
...
#         pytest.skip("Empty Bearer token. Skipping test")
#     try:
#         AlertsTypesLevelAllCustomDateRange = AllAlerts(globalvariables.accountId, globalvariables.iso1weekcustom, globalvariables.isoend,
#                                                            globalvariables.page_1, globalvariables.page_100)
